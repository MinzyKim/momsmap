...
public class LessonVO {
     ...
     private int key; 
     private String  ag3_lsn_dcnt;     
     private String ag4_lsn_dcnt;     
     private String ag5_lsn_dcnt;     
     private String mix_age_lsn_dcnt;
     private String  spcl_lsn_dcnt; 
     private String afsc_pros_lsn_dcnt;
     private String ldnum_blw_yn;     
     private String fdtn_kndr_yn;
	public LessonVO() {
		super();
