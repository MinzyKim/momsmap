...
var markerImageUrl = './images/사립(법인).png', 
markerImageUrl2 = './images/사립(사인).png',
markerImageUrl3 = './images/공립(단설)빨강.png',
markerImageUrl4 = './images/공립(병설)빨강.png',
...
function Random (n){
if(n==1) { markerImage = markerImage1; }
else if(n==2) { markerImage = markerImage2; }
else if(n==3) { markerImage = markerImage3; }
else if(n==4) { markerImage = markerImage4; }
...
var markerPosition3  = new kakao.maps.LatLng(37.50393015990904,127.03803403247034); 
...
var markerPosition4  = new kakao.maps.LatLng(37.50338090534929, 127.0369028067005); 
